...
namespace Omen
{
    public static class UXTheme
    {
        ...
        {
            UInt32 colorType = GetImmersiveColorTypeFromName(Marshal.StringToHGlobalUni("ImmersiveSystemAccent"));

            return AccentColorSet.ActiveSet[colorType];
        }
        ...
        public static extern UInt32 GetImmersiveColorFromColorSetEx(UInt32 immersiveColorSet, UInt32 immersiveColorType, Boolean ignoreHighContrast, UInt32 highContrastCacheMode);
